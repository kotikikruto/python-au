...
def main():
    config = Config(path_to_task_text="test_data/task.txt", path_to_solution="test_data/solution.py",
                    path_to_result="task.md", url="https://leetcode.com/problems/intersection-of-two-linked-lists/",
                    path_to_tests="test_data/tests.py", task_name="Intersection of Two Linked Lists")
